...
def generate_notebook_solution(expr_str, t0_val, y0_val):
    ...
    if expr_str.strip() == "-2*y + sin(t)":
        ...
        steps.append("Endi $u(t)$ ni topish uchun bo'laklab integrallash ($u dv$ usuli) qoidasini qo'llaymiz:")
        ...
        steps.append("**6-Qadam: Boshlang'ich shart y(0)=1 orqali C ni topish.**")
        ...
        steps.append(f"Berilgan tenglama: $$y' = {sp.latex(f_s)}$$")
        ...
        steps.append(f"3. Integrallashdan so'ng hosil bo'lgan ixtiyoriy $C$ ozgarmasini aniqlash uchun $t_0={t0_val}$ va $y_0={y0_val}$ boshlang'ich shartlari o'rniga qo'yiladi.")
...
if st.sidebar.button("🚀 Qadamba-Qadam Hisoblash", type="primary"):
    ...
    st.info("Kiritilgan parametrlarni tasdiqlash uchun chap tomondagi tugmani bosing.")ugmani bosing.")
